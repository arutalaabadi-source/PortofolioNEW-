...
const projects={
  ...
  bpr:{category:"Process Improvement",title:"Business Process Reengineering",description:"Redesigning warehouse processes to reduce unnecessary activities and improve operational efficiency.",images:["images/projects/bpr/1.jpg","images/projects/bpr/2.jpg","images/projects/bpr/3.jpg","images/projects/bpr/4.jpg"],tools:["BPR","PAM","BPMN","Process Improvement"],results:["Reduced unnecessary process activities","Improved process flow","Eliminated non-value-added activities","Created a more efficient warehouse process"]},
  inventory:{category:"Digitalization",title:"Inventory Digital System",description:"Digital recording system for goods In/Out using AppSheet and barcode scanning.",images:["images/projects/inventory/1.jpg","images/projects/inventory/2.jpg","images/projects/inventory/3.jpg"],tools:["AppSheet","Barcode","Google Sheets","Dashboard"],results:["Digitalized goods In/Out transactions","Supported real-time transaction recording","Reduced manual data entry","Improved stock monitoring"]},
